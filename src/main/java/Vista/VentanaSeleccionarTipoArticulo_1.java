...
public class VentanaSeleccionarTipoArticulo_1 extends javax.swing.JFrame {
    private Supertlon controlador;
    private Administrativo admin;
    private SucursalGimnasio sucursal;
    
    public VentanaSeleccionarTipoArticulo_1(Administrativo admin, SucursalGimnasio sucursal) {
        initComponents();
